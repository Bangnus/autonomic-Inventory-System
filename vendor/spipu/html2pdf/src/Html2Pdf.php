...
<html>
    ...
    protected function _tag_open_P($param)
    {
        ...
        $this->parsingCss->value['font-family'] = 'thsarabunnew';
        $this->parsingCss->value['font-size']   = $this->cssConverter->convertFontSize('12px');
        $this->parsingCss->value['font-bold']   = false;
